...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Authentication failed. Unauthorized access.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-widest text-glow uppercase">System Login</h1>
        ...
        <div className="mt-6 text-center">
          <Link href="/register" className="text-muted-foreground hover:text-primary text-sm transition-colors">
